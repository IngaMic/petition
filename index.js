    ...
    bc.hash(password)
        .then((result) => {
            ...
            db.getLogin(email)
                .then((result) => {
                    ...
                    if (result.rows[0] && result.rows[0].id) {
                        ...
                        if (
                            ...
                            db.registerInfo(first, last, email, password)
                                .then((result) => {
                                ...
                                .catch((err) => {
                                    console.log(
                                        "trouble with inserting registration data",
                                        err
                ...
                .catch((err) => {
                    console.log(
                        "err in checking if email already registered",
                        err
                    );
                });
        })
...
app.post("/profile", notProfiled, (req, res) => {
    ...
    db.addProfile(age || null, city || null, url || null, user_id)
        .then(() => {
    ...
    db.getSignature(signatureId)
        .then((result) => {
            ...
            db.getProfile()
                ...
                .catch((err) => {
                    console.log("err in getProfile GET /thanks", err);
                });
        })
        .catch((err) => {
...
app.get("/edit", (req, res) => {
    if (req.session.registeredId) {
        ...
        db.getpersonalProfile(userid)
            ...
            .catch((err) => {
                console.log("err in getting personalProfile", err);
            });
    }
});
app.post("/edit", (req, res) => {
    ...
    if (!password) {
        console.log("block 1");
        db.updateTableNoPas(first, last, email, userid)
            .then(() => {
                db.updateProfile(age || null, city || null, url || null, userid)
                    .then(() => {
                    ...
                    .catch((err) => {
                        console.log(
                            "trouble with updateProfile while updating noPas POST /edit",
                            err
                        );
                    });
            })
            .catch((err) => {
                console.log(
                    "trouble with updateTableNoPas while updating POST /edit",
                    err
                );
            });
    } else {
                ...
                db.updateTableNoPas(first, last, email, userid)
                    .then(() => {
                        db.updateProfile(
                            ...
                            .catch((err) => {
                                console.log(
                                    "trouble with updateProfile while updating withPassword POST /edit",
                                    err
                                );
                            });
                    })
                ...
                .then((info) => {
                    ...
                    if (info) {
                        db.deleteSignature(userid)
                            ...
                            .catch((err) => {
                                console.log(
                                    "err in getting personalProfile",
                                    err
                                );
                            });
                    } else {
